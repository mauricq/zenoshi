...
trait RepositoryTrait
{
     ...
     * @throws ORMException
     */
    public function removeById(string $class, string $id, bool $flush = true): void
    {
     ...
     */
    public function insert(object $entity, bool $flush = true): ?EntityProvider
    {
     ...
     */
    public function update(object $entity, bool $flush = true): EntityProvider
    {
        $this->_em->persist($entity);
        if($flush) {
            $this->_em->flush();
     ...
     * @return EntityProvider
     */
    public function merge(object $entity, bool $flush = true): EntityProvider
    {
